...
public:
	...
	std::set<std::string> getDict();	//return set of all words in dictionary, used to create TrieSet

private://Add more public and private functions/variables here.

	std::set <std::string> dict;
	void CheckCaps(std::string &temp);	//checks each word for capital letters
};
